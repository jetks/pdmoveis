...
function nextTurn() {
	...
	if (currentTurn <= totalTurns) {
		if (isBreakTime) {
			...
			showNotification("Hora de descansar", "Muito bem, aproveite os próximos minutos para descansar");
		} else {
			totalTime = workTime;
			showNotification("Voltando aos estudos", "Você está quase lá, só mais alguns minutinhos");
		}
		timeRemaining = totalTime;
	} else {
		reset();
